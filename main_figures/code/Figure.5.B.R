...
filtered_data <- together %>%
  filter(New_Genotypes %in% c("G2P[4]", "'MF469162.1_human'", "'MW280957.1_eqlike'", "G9P[8]", "G1P[8]", "G12P[8]", "G4P[8]", "G9P[4]") & `Rotarix-vaccination-status` != "UNKNOWN" & Age_Group == "0-2" & `RotaTeq-vaccination-status` != "Y")


# # Filter the data frame to include relevant genotypes and exclude "UNKNOWN" status, look at only 2021-2022
# filtered_data2 <- together %>%
